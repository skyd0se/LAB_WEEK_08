...
//the service process
private val mutableSecondID = MutableLiveData<String>()
        val trackingSecondCompletion: LiveData<String> = mutableSecondID
    }
}
